...
describe('Test users endpoint', function () {
  ...
  it('get the /users GET endpoint', function (done) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              request.get('/users').set('Authorization', 'Bearer ' + TEST_TOKEN)
            ];
          case 1:
            response = _a.sent();
  ...
  it('get the /users/:id GET endpoint', function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  it('get the /users POST endpoint', function (done) {
    return __awaiter(void 0, void 0, void 0, function () {
      var response;
      return __generator(this, function (_a) {
        switch (_a.label) {
