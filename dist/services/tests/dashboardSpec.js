...
describe('Dashboard service', function () {
    ...
    it("currentOrderByUser method should return a list of orders and users", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.currentOrderByUser("1")];
                case 1:
                    result = _a.sent();
